...
OtterBot separates deterministic execution regressions from real-model task quality.
...
stream through OtterBot's existing generic connection. It does not replace Pi.
