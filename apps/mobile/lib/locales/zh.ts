export const ZH_MESSAGES: Record<string, string> = {
  ...
  "Enter your OtterBot server address.": "输入你的 OtterBot 服务器地址。",
  "Show less": "收起",
  Members: "成员",
  Max: "最高",
  Minimal: "最低",
  ...
  "Point this app at your self-hosted OtterBot origin, the same HTTPS URL you open in a browser.":
    "将此应用指向你自托管的 OtterBot 源站，地址与你在浏览器中打开的 HTTPS URL 相同。",
  Private: "私有",
  Providers: "提供商",
  ...
  "Show {label}": "显示 {label}",
  "Sign in": "登录",
  "Sign in to OtterBot": "登录 OtterBot",
  "Sign out": "退出登录",
  "Sign up": "注册",
  "Sign up for OtterBot": "注册 OtterBot",
  "Sign-in": "登录",
  "Sign-up": "注册",
  ...
  "That URL did not look like an OtterBot server": "该地址看起来不是 OtterBot 服务器",
  ...
  "Paste the OpenAI-compatible address from your server. OtterBot adds /v1 if needed.":
    "粘贴你服务器的 OpenAI 兼容地址。如有需要，OtterBot 会自动补上 /v1。",
  Paused: "已暂停",
  Prompt: "提示词",
  ...
  "This subscription sign-in is not available in OtterBot yet. Use a deployment credential or choose another provider.":
    "OtterBot 暂不支持此订阅登录。请使用部署凭据或选择其他提供商。",
  "Tool sources": "工具源",
  Tools: "工具",
  Uninstall: "卸载",
