...
const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    ...
    selfHost: {
      ...
      copy: "Run OtterBot on your machine. Your keys, your model, your data.",
      features: [
        {
    ...
    getStartedDialog: {
      ...
      cloudHint: "Hosted OtterBot is coming. Leave your email.",
      back: "Back",
      successTitle: "You're in.",
      successCopy:
        "We'll email you when hosted OtterBot is ready. Want to start today? Jump to Self-host on this page.",
      done: "Done",
      viewOnGithub: "View on GitHub",
    },
    waitlist: {
  ...
  de: {
    ...
    hero: {
      ...
      lead: "OtterBot ist eine Open-Source-Alternative zu Grok Bot. Gib einem Bot echte Arbeit. Er meldet sich in deinen Tools an, nutzt sie wie du. Er kommt zurück, wenn er dich braucht.",
      getStarted: "Loslegen",
      viewOnGithub: "Auf GitHub ansehen",
    ...
    selfHost: {
      ...
      copy: "Betreibe OtterBot auf deiner Maschine. Deine Keys, dein Modell, deine Daten.",
      features: [
        {
    ...
    cta: {
      ...
      copy: "Gib OtterBot etwas, das du aufgeschoben hast. Lass es den Follow-through übernehmen.",
      getStarted: "Loslegen",
      viewOnGithub: "Auf GitHub ansehen",
      openSourceValue: "Open Source",
      selfHostValue: "Self-host",
    ...
    getStartedDialog: {
      ...
      cloudHint: "Gehostetes OtterBot kommt. Hinterlasse deine E-Mail.",
      back: "Zurück",
      successTitle: "Du bist dabei.",
      successCopy:
        "Wir mailen dir, wenn gehostetes OtterBot bereit ist. Heute starten? Zum Self-host-Abschnitt auf dieser Seite.",
      done: "Fertig",
      viewOnGithub: "Auf GitHub ansehen",
    },
    waitlist: {
  ...
  ko: {
    ...
    selfHost: {
      eyebrow: "셀프 호스트",
      heading: "컴퓨터는 당신 것",
      copy: "당신 머신에서 OtterBot를 실행하세요. 키, 모델, 데이터는 모두 당신 것.",
      features: [
        {
    ...
    getStartedDialog: {
      ...
      cloudHint: "호스팅 OtterBot가 곧 옵니다. 이메일을 남겨 주세요.",
      back: "뒤로",
      successTitle: "등록되었습니다.",
      successCopy:
        "호스팅 OtterBot가 준비되면 메일로 알려 드립니다. 오늘 시작하려면 이 페이지의 셀프 호스트 섹션으로 이동하세요.",
      done: "완료",
      viewOnGithub: "GitHub에서 보기",
    },
    waitlist: {
  ...
  zh: {
    title: "OtterBot | 开源 Grok Bot 替代品",
    description:
      "OtterBot 是一个开源 Grok Bot 替代品，用于运行真正干活的持久化 AI 队友。密钥、模型、机器，都归你所有。",
    ogImageAlt: "OtterBot：真正属于你的 AI 队友。密钥、模型、机器，都归你所有。",
    ...
    hero: {
      ...
      lead: "OtterBot 是一个开源 Grok Bot 替代品。把真正的工作交给 Bot：它会登录你的工具，像你一样使用它们，并在需要你时回来询问。",
      getStarted: "开始使用",
      viewOnGithub: "在 GitHub 上查看",
    ...
    selfHost: {
      eyebrow: "自托管",
      heading: "电脑归你所有",
      copy: "在你自己的机器上运行 OtterBot。密钥、模型、数据，都归你所有。",
      features: [
        {
          title: "任意模型，密钥归你",
    ...
    openSource: {
      ...
      copy: "OtterBot 采用 Apache-2.0 许可证，在你自己的机器上用你自己的模型密钥运行。没有功能墙，也不会偷偷外联。",
      selfHostTitle: "自托管",
      selfHostMeta: "现已可用",
      selfHostItems: [
        "Docker 运行器和沙箱浏览器",
    ...
    cta: {
      heading: "认识你的第一个 Bot",
      copy: "把一件你一直拖延的事交给 OtterBot，让它负责跟进到底。",
      getStarted: "开始使用",
      viewOnGithub: "在 GitHub 上查看",
      openSourceValue: "开源",
      selfHostValue: "自托管",
    ...
    getStartedDialog: {
      ...
      cloudHint: "托管版 OtterBot 即将推出。留下你的邮箱。",
      back: "返回",
      successTitle: "登记成功。",
      successCopy:
        "托管版 OtterBot 就绪时我们会邮件通知你。想今天就上手？跳到本页的自托管部分。",
      done: "完成",
      viewOnGithub: "在 GitHub 上查看",
    },
    waitlist: {
